-- 016: Add season_type + round to search_events return
-- These fields are only used for display headers (not search criteria).
-- Drops and recreates the function with 2 extra return columns.
