/**
 * Log It — MLB Sync (standalone runner)
 * Run locally: npx tsx api/scripts/sync-mlb.ts
 *
 * Fetches MLB games for today ±7 days from ESPN and upserts into Supabase.
 * Same logic as api/cron/sync-mlb.ts but runs as a CLI script.
 */
