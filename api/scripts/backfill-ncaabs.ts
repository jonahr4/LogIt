/**
 * Log It — NCAA Baseball Backfill (standalone runner)
 * Run locally: npx tsx api/scripts/backfill-ncaabs.ts [seasons]
 * Example: npx tsx api/scripts/backfill-ncaabs.ts 2024,2025
 *
...
async function main() {
  ...
  console.log(`\n⚾ NCAA Baseball Backfill — Seasons: ${seasons.join(', ')}\n`);
