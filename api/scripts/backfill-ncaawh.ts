/**
 * Log It — WNCAA Hockey Backfill (standalone runner)
 * Run locally: npx tsx api/scripts/backfill-ncaawh.ts [seasons]
 * Example: npx tsx api/scripts/backfill-ncaawh.ts 2023,2024
 *
...
async function main() {
  ...
  console.log(`\n🏒 WNCAA Hockey Backfill — Seasons: ${seasons.join(', ')}\n`);
