/**
 * Log It — WNBA Sync (standalone runner)
 * Run locally: npx tsx api/scripts/sync-wnba.ts
 *
 * Fetches WNBA games for today ±7 days from ESPN and upserts into Supabase.
 * Same logic as api/cron/sync-wnba.ts but runs as a CLI script.
 */
