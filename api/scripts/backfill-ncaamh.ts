/**
 * Log It — NCAA Hockey Backfill (standalone runner)
 * Run locally: npx tsx api/scripts/backfill-ncaamh.ts [seasons]
 * Example: npx tsx api/scripts/backfill-ncaamh.ts 2023,2024
 *
...
async function main() {
  ...
  console.log(`\n🏒 NCAA Hockey Backfill — Seasons: ${seasons.join(', ')}\n`);
