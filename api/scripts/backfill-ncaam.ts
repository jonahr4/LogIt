/**
 * Log It — NCAA Basketball Backfill (standalone runner)
 * Run locally: npx tsx api/scripts/backfill-ncaam.ts [seasons]
 * Example: npx tsx api/scripts/backfill-ncaam.ts 2023,2024
 *
...
async function main() {
  ...
  console.log(`\n🏀 NCAA Basketball Backfill — Seasons: ${seasons.join(', ')}\n`);
